...
class DataTransformationConfig:
    artifect_dir = os.path.join(artifact_folder)
    transformed_train_file_path = os.path.join(artifect_dir, "train.npy")
    transformed_test_file_path = os.path.join(artifect_dir, "test.npy")
    transformed_object_file_path = os.path.join(artifect_dir, "preprocessor.pkl")
