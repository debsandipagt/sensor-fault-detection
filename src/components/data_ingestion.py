...
"""
This class is designed to hold configuration settings related to data ingestion, 
specifically the path to the folder where artifacts (like exported data files) will be stored.
"""
@dataclass
...
class DataIngestion:
    ...
    def export_data_into_feature_store_file_path(self)->pd.DataFrame:
        ...
        try:
            ...
            raw_file_path = self.data_ingestion_path.artifact_folder
            os.makedirs(raw_file_path, exist_ok=True)

            sensor_data = self.export_collection_as_df(
